...
$.getJSON('https://francini-ap.github.io/datos_actubreurbano2/arboles_ap_tv_cbima.geojson', function (geojson) {
  var capa_cantones_gam_coropletas = L.choropleth(geojson, {
	 ...
	 onEachFeature: function popup_registros (feature, layer) {
	layer.bindPopup("<div style=text-align:center><h3>"+feature.properties.distrito+
	  "<h3></div><hr><table><tr><td>Área de trama verde : "+feature.properties.tv_ap_2+'m2'+
	  "</td></tr><tr><td> Porcentaje de trama verde en el área de protección: "+feature.properties.por_tv+'%'+
...
$.getJSON('https://francini-ap.github.io/datos_actubreurbano2/tem2.geojson', function (geojson) {
  var capa_cantones_gam_coropletas = L.choropleth(geojson, {
	...
	layer.bindPopup("<div style=text-align:center><h3>"+feature.properties.canton_1+
	  ...
	  "</td></tr><tr><td> Temperatura máxima: "+feature.properties.temp_max+'°C'+
...
"</td></tr></table>",
  ...
  control_capas.addOverlay(capa_cantones_gam_coropletas, 'Temperaturas superficiales de la tierra');	
...
$.getJSON('https://francini-ap.github.io/datos_actubreurbano2/ai2.geojson', function (geojson) {
  var capa_cantones_gam_coropletas = L.choropleth(geojson, {
	 ...
	 onEachFeature: function popup_registros (feature, layer) {
	layer.bindPopup("<div style=text-align:center><h3>"+feature.properties.distrito+
	  "<h3></div><hr><table><tr><td>Área asentamientos informales : "+feature.properties.area_ai_2 + 'm2'+
...
"</td></tr></table>",
  ...
  control_capas.addOverlay(capa_cantones_gam_coropletas, 'Porcentajede de ocupación de los asentamientos informales por distrito');	
...
$.getJSON('https://francini-ap.github.io/datos_actubreurbano2/ai2.geojson', function (geojson) {
  var capa_cantones_gam_coropletas = L.choropleth(geojson, {
	 ...
	 onEachFeature: function popup_registros (feature, layer) {
	layer.bindPopup("<div style=text-align:center><h3>"+feature.properties.distrito+
	  "<h3></div><hr><table><tr><td>Área trama verde : "+feature.properties.tv_ai_2 + 'm2'+
	  "</td></tr><tr><td> Población asentamiento informal: "+feature.properties.poblacion+
	  "</td></tr><tr><td> Trama verde por habitante: "+feature.properties.por_par_ai+
